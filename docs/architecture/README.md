...
- `harness/workflow-plugins/code-workflow/`：shared `code-workflow` package 提供 stage runner，项目把本地 guardrail 挂到 `pre-commit-quick`、`completion-full`、`workflow-governance` 这三个 workflow stage 的注册点。
