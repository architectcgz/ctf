...
- Related prior work:
  - `docs/plan/archive/impl-plan/2026-06/2026-06-06-harness-bridges-relocation-implementation-plan.md`
...
- Create:
  - `docs/plan/archive/impl-plan/2026-06/2026-06-06-harness-bridge-boundary-reduction-implementation-plan.md`
- Modify:
  - `AGENTS.md`
  - `.githooks/README.md`
  - `scripts/check-commit-message.sh`
