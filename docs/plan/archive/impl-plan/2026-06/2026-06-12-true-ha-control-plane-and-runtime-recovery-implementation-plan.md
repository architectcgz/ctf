...
1. T1 `redis-sentinel-and-postgres-ha-connectivity`（已完成，状态面 HA 前置基线）
   - Plan: `docs/plan/archive/impl-plan/2026-06/2026-06-12-true-ha-group/redis-sentinel-and-postgres-ha-connectivity.md`
2. T2 `shared-storage-owner-convergence`（已完成，文件与密钥共源）
   - Plan: `docs/plan/archive/impl-plan/2026-06/2026-06-12-true-ha-group/shared-storage-owner-convergence.md`
...
4. T4 `distributed-event-bus-and-outbox-relay`（已完成，跨副本 side effect 与 outbox/stream owner）
   - Plan: `docs/plan/archive/impl-plan/2026-06/2026-06-12-true-ha-group/distributed-event-bus-and-outbox-relay.md`
