...
- grill-with-docs findings:
  - `docs/plan/archive/impl-plan/2026-06/2026-06-12-true-ha-control-plane-and-runtime-recovery-implementation-plan.md` 明确报告和附件 LocalFS 是 API 多副本 correctness blocker。
