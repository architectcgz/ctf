...
> 后续：legacy cleanup fallback 已由 `docs/plan/archive/impl-plan/2026-06/2026-06-03-runtime-acl-legacy-fallback-retirement-plan.md` 继续推进；本文中关于 fallback 窗口的描述仅保留当时的实施背景。
