...
- Source docs:
  ...
  - `docs/plan/archive/impl-plan/2026-06/2026-06-10-ops-assessment-event-readmodel-boundary-plan.md`
...
- Modify:
  ...
  - `code/backend/internal/module/architecture_test.go`
  - `docs/architecture/backend/07-modular-monolith-refactor.md`
  - `docs/plan/archive/impl-plan/2026-06/2026-06-11-module-dependency-baseline-classification-implementation-plan.md`
- Review:
