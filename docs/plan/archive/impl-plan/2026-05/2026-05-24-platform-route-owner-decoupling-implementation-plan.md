...
- `ClassStudentsPage`、`StudentAnalysisPage` 的 route-level 公共消费点也已经收口到 `@/components/class-management`；teacher / platform route view 不再直接依赖 `components/teacher/class-management/*.vue` 路径。
