...
2. 继续拆分 `runtime/infrastructure.Repository` 中剩余的 AWD workspace / AWD service operation persistence、runtime state index 和 migration-facing state lookup，不再把 allocation 方法加回宽仓储。
