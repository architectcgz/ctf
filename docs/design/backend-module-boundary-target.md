...
2. 继续判断 `runtimeinfra.RuntimeStateRepository` 是否还要再按 inventory/index/migration view 细拆，但不要恢复广义 `runtime/infrastructure.Repository`。
