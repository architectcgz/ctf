  ...
  >
    <main class="content-pane">
      <div class="contest-page">
        ...
        <section class="student-directory-section workspace-directory-section" aria-label="竞赛目录">
          <section class="student-directory-shell contest-directory workspace-directory-list">
            ...
            <div v-if="loading" class="contest-loading student-directory-state workspace-directory-loading">
...
const props = defineProps<{
  loading: boolean
  visibleContests: ContestListItem[]
  total: number
  page: number
  totalPages: number
  summaryMetrics: ContestSummaryMetric[]
  loadErrorMessage: string
  statusFilter: ContestStatusFilter
  modeFilter: ContestModeFilter
  refresh: () => void | Promise<void>
  changePage: (page: number) => void | Promise<void>
  updateStatusFilter: (value: ContestStatusFilter) => void | Promise<void>
...
function onStatusFilterChange(event: Event): void {
  void props.updateStatusFilter((event.target as HTMLSelectElement).value as ContestStatusFilter)
}

function onModeFilterChange(event: Event): void {
  void props.updateModeFilter((event.target as HTMLSelectElement).value as ContestModeFilter)
}
</script>
