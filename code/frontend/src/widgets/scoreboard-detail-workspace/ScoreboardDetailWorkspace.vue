    ...
    <main class="content-pane">
      <div class="scoreboard-detail-page">
        ...
        <section
          ...
          aria-label="排行详情"
        >
          <section class="student-directory-shell scoreboard-detail-directory workspace-directory-list">
            <header class="student-directory-shell__head student-directory-list-heading list-heading">
              ...
              <div class="student-directory-shell__meta scoreboard-detail-directory__meta">
                ...
                <span v-if="scoreboard?.frozen" class="scoreboard-frozen-inline">
            ...
            >
              <template #action>
                <button type="button" class="ui-btn ui-btn--secondary" @click="loadScoreboard(true)">
                  重新加载
                </button>
              </template>
            </AppEmpty>
...
import type { ContestScoreboardData, ContestStatus, ScoreboardRow } from '@/api/contracts'
...
defineProps<{
  contest: ContestScoreboardData['contest'] | null | undefined
  page: number
  rows: ScoreboardRow[]
  scoreboard: ContestScoreboardData | null
  total: number
  totalPages: number
  loading: boolean
  refreshing: boolean
  ...
  loadScoreboard: (silent?: boolean, nextPage?: number) => void | Promise<void>
}>()
</script>
