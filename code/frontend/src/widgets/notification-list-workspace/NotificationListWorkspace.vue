...
import { NotificationCategoryFilter } from '@/features/notifications'
...
defineProps<{
  ...
  headStats: ReadonlyArray<{ key: string; label: string; value: number }>
  ...
  handlePublishSuccess: () => Promise<void>
