...
import PlatformAwdReviewDetailRoutePage from '@/pages/awd-review/PlatformAwdReviewDetailRoutePage.vue'
...
describe('PlatformAwdReviewDetail route owner', () => {
  ...
  it('应使用平台 route view，并通过中性 feature 承接 AWD 复盘详情 workflow', async () => {
    ...
    const wrapper = mount(PlatformAwdReviewDetailRoutePage)
