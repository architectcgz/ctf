...
import ScoreboardDetail from '@/pages/scoreboard/ScoreboardDetailRoutePage.vue'
import ScoreboardView from '@/pages/scoreboard/ScoreboardViewRoutePage.vue'
...
describe('ScoreboardView', () => {
  ...
  it('提供竞赛排行榜与积分排行榜两个页签，并展示积分榜字段', async () => {
    ...
    expect(scoreboardWorkspaceShellSource).toContain('scoreboard-tab-points')
  })
})
