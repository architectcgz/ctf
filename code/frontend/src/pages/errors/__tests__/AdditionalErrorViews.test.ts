...
import UnauthorizedView from '@/pages/errors/UnauthorizedRoutePage.vue'
import TooManyRequestsView from '@/pages/errors/TooManyRequestsRoutePage.vue'
import InternalServerErrorView from '@/pages/errors/InternalServerErrorRoutePage.vue'
import BadGatewayView from '@/pages/errors/BadGatewayRoutePage.vue'
import ServiceUnavailableView from '@/pages/errors/ServiceUnavailableRoutePage.vue'
import GatewayTimeoutView from '@/pages/errors/GatewayTimeoutRoutePage.vue'
