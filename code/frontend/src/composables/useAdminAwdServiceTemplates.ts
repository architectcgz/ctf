...
export interface AdminAwdServiceTemplateFormDraft {
  name: string
  slug: string
  category: string
...
function createEmptyDraft(): AdminAwdServiceTemplateFormDraft {
  return {
    name: '',
    slug: '',
    category: 'web',
...
export function useAdminAwdServiceTemplates() {
  ...
  const formDraft = ref<AdminAwdServiceTemplateFormDraft>(createEmptyDraft())
  ...
  async function saveTemplate(draft: AdminAwdServiceTemplateFormDraft) {
    saving.value = true
