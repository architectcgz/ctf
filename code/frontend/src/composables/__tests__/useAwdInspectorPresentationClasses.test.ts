...
import awdInspectorDerivedDataSource from '@/composables/useAwdInspectorDerivedData.ts?raw'
import awdInspectorFormattingSource from '@/composables/useAwdInspectorFormatting.ts?raw'
