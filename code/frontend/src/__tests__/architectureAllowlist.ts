...
export const widgetLegacyComponentImportAllowlist = new Set([
  ...
  'widgets/awd-review-workspace/TeacherAWDReviewWorkspace.vue -> @/components/teacher/awd-review/TeacherAWDReviewAnalysisSection.vue',
...
export const featureRouterImportAllowlist = new Set([
  ...
  'features/awd-review-workspace/model/useTeacherAwdReviewIndex.ts -> vue-router',
