  ...
  >
    ...
    >
      ...
      <fieldset class="publish-field">
        ...
        <div
          v-if="publisher.audienceTarget.value === 'role'"
        ...
        <span
          v-if="publisher.errors.audience"
          class="publish-error mt-2"
        >{{
