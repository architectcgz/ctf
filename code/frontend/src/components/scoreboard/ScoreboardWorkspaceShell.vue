                ...
                <label class="student-directory-filter-field" for="scoreboard-status-filter">
                  ...
                  <div class="ui-control-wrap student-directory-filter-control">
                    <select
                      ...
                      class="ui-control"
                      @change="emitContestStatusFilterChange"
                    >
                ...
                <label class="student-directory-filter-field" for="scoreboard-mode-filter">
                  ...
                  <div class="ui-control-wrap student-directory-filter-control">
                    <select
                      ...
                      class="ui-control"
                      @change="emitContestModeFilterChange"
                    >
            ...
            <template v-else>
              ...
              <div class="scoreboard-pagination workspace-directory-pagination">
                <PagePaginationControls
                  ...
                  :disabled="loading"
                  show-jump
                  @change-page="emit('change-contest-page', $event)"
                />
              </div>
            </template>
          </section>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <template #action>
                <button
                  type="button"
                  class="ui-btn ui-btn--secondary"
                  @click="emit('refresh-practice-ranking')"
                >
                  重新加载
                </button>
              </template>
            ...
            <div
              v-else
              class="scoreboard-table-scroll overflow-x-auto"
            >
