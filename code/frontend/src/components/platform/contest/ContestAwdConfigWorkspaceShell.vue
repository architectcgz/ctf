...
interface AwdHttpStandardPreset {
  id: string
  label: string
}

interface AwdHttpActionDraft {
  method: string
  path: string
...
interface AwdHttpActionSection {
  key: string
  title: string
  pathErrorKey?: string
...
interface AwdLegacyProbeDraft {
  health_path: string
}

interface AwdCheckerFormDraft {
  sla_score: number
  defense_score: number
}

interface AwdPreviewFormDraft {
  access_url: string
  preview_flag: string
}

interface AwdTcpCheckerStepDraft {
  send: string
...
interface AwdTcpStandardDraft {
  timeout_ms: number | null
  steps: AwdTcpCheckerStepDraft[]
}

interface AwdScriptCheckerDraft {
  runtime: string
  output: string
