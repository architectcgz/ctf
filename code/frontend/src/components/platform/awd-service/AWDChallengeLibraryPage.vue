...
import { Activity, Box, CheckCircle, Clock, RefreshCw, Upload } from 'lucide-vue-next'
  ...
  >
    <div class="workspace-grid">
      <main class="content-pane awd-challenge-library-content">
        ...
        <div>
          <div v-if="mode === 'library'" class="awd-library-pane">
            <div
              ...
              >
                ...
                <template v-else>
                  <AppEmpty
                    ...
                    title="暂无 AWD 题目"
                    :description="
                      hasActiveFilters ? '当前筛选条件下没有匹配题目。' : '还没有 AWD 题目。'
                    "
                  />
          ...
          <div v-if="mode === 'import'" class="awd-import-pane">
            ...
            <section class="workspace-directory-section awd-import-queue-section">
              <header class="list-heading awd-challenge-import__queue-head">
                ...
                <span class="awd-challenge-import__queue-count"
                  >共 {{ importQueueCount }} 个待确认包</span
                >
              </header>
              ...
              <div v-else class="workspace-directory-list awd-challenge-import__queue">
                ...
                >
                  ...
                  <div class="awd-challenge-import__chips">
                    <span class="awd-status-pill awd-status-pill--primary">{{
                      item.service_type
                    }}</span>
                    <span class="awd-status-pill awd-status-pill--warning">{{
                  ...
                  <div class="awd-challenge-import__image">
                    ...
                    <strong :title="getImportTargetImageRef(item)">{{
                      getImportTargetImageRef(item)
                    }}</strong>
                  ...
                  <div class="awd-challenge-import__grid">
                    <pre class="awd-challenge-import__json">{{
                      formatStructuredJSON(item.access_config)
                    }}</pre>
                    <pre class="awd-challenge-import__json">{{
