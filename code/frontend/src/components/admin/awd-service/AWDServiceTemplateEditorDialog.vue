...
import type { AdminAwdServiceTemplateFormDraft } from '@/composables/useAdminAwdServiceTemplates'

const props = defineProps<{
  open: boolean
  mode: 'create' | 'edit'
  draft: AdminAwdServiceTemplateFormDraft
  saving: boolean
}>()

const emit = defineEmits<{
  'update:open': [value: boolean]
  save: [value: AdminAwdServiceTemplateFormDraft]
}>()

const localDraft = reactive<AdminAwdServiceTemplateFormDraft>({
  name: '',
  slug: '',
  category: 'web',
  difficulty: 'medium',
...
const fieldErrors = reactive<Partial<Record<keyof AdminAwdServiceTemplateFormDraft, string>>>({})
