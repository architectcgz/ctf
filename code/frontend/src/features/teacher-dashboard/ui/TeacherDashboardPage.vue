...
import TeacherDashboardPortraitPanel from '@/components/teacher/dashboard/TeacherDashboardPortraitPanel.vue'
import TeacherDashboardReviewPanel from '@/components/teacher/dashboard/TeacherDashboardReviewPanel.vue'
