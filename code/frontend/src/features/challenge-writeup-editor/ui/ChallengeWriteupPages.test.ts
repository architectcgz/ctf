...
import challengeWriteupRouteSource from '@/pages/platform/challenges/ChallengeWriteupRoutePage.vue?raw'
import challengeWriteupViewRouteSource from '@/pages/platform/challenges/ChallengeWriteupViewRoutePage.vue?raw'
