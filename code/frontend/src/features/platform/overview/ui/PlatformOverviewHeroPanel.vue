  ...
  <section id="admin-dashboard-overview" class="overview-panel">
    <header class="workspace-page-header overview-page-header">
      ...
      <div class="overview-hero-actions">
        ...
        <div class="header-actions overview-action-grid">
          <AppRouteLink :to="props.auditLogRoute" class="header-btn header-btn--primary">
            <Clock class="h-4 w-4" />
            审计日志
          </AppRouteLink>
          <AppRouteLink :to="props.cheatDetectionRoute" class="header-btn header-btn--ghost">
    ...
    <div v-if="props.error" class="workspace-alert" role="alert" aria-live="polite">
      ...
      <div class="workspace-alert-actions">
        ...
        <AppRouteLink :to="props.auditLogRoute" class="ui-btn ui-btn--ghost">
          <Clock class="h-4 w-4" />
          审计日志
        </AppRouteLink>
      </div>
