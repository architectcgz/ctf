...
import studentLegacyOverviewSource from '@/features/student-dashboard/ui/StudentOverviewPage.vue?raw'
...
describe('shared theme token adoption', () => {
  ...
  it('后台工作区页不应回退到局部硬编码主题令牌', () => {
    ...
    expectNoHardcodedThemeTokens(topologyCanvasQuickEditorSource, 'TopologyCanvasQuickEditor', [
      'rgba(15, 23, 42, 0.96)',
      'rgba(15, 23, 42, 0.9)',
      'border-[var(--color-success)]',
      'bg-[var(--color-success)]/10',
    ...
    expectNoHardcodedThemeTokens(
      topologyCanvasWorkspaceSectionSource,
    ...
    expectNoHardcodedThemeTokens(topologyNetworkQuickEditorSource, 'TopologyNetworkQuickEditor', [
      'rgba(15, 23, 42, 0.96)',
      'rgba(15, 23, 42, 0.9)',
      'border-[var(--color-success)]',
      'bg-[var(--color-success)]/10',
