...
import { useTeacherReportExportPage } from '@/composables/useTeacherReportExportPage'
...
const {
  ...
  handleExport,
  handleDownload,
} = useTeacherReportExportPage()
</script>

<template>
  <section
    class="report-shell report-hero journal-shell teacher-management-shell teacher-surface teacher-surface-workspace-bg flex min-h-full flex-1 flex-col rounded-[30px] px-6 py-6 md:px-8"
  >
