  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: 'AWD 战场总览', contentLayout: 'bleed' },
      },
      {
        path: 'contests/:id/awd/services',
        name: 'ContestAwdServices',
        component: () => import('@/modules/awd/views/student/StudentAwdServicesView.vue'),
        meta: { requiresAuth: true, title: 'AWD 我的服务', contentLayout: 'bleed' },
      },
      {
        path: 'contests/:id/awd/targets',
        name: 'ContestAwdTargets',
        component: () => import('@/modules/awd/views/student/StudentAwdTargetsView.vue'),
        meta: { requiresAuth: true, title: 'AWD 目标目录', contentLayout: 'bleed' },
      },
      {
        path: 'contests/:id/awd/attacks',
        name: 'ContestAwdAttacks',
        component: () => import('@/modules/awd/views/student/StudentAwdAttacksView.vue'),
        meta: { requiresAuth: true, title: 'AWD 攻击记录', contentLayout: 'bleed' },
      },
      {
        path: 'contests/:id/awd/collab',
        name: 'ContestAwdCollab',
        component: () => import('@/modules/awd/views/student/StudentAwdCollabView.vue'),
        meta: { requiresAuth: true, title: 'AWD 队伍协作', contentLayout: 'bleed' },
      },
      {
        path: 'scoreboard',
        name: 'Scoreboard',
      ...
      {
        path: 'academy/awd-reviews/:contestId/overview',
        name: 'TeacherAwdOverview',
        component: () => import('@/modules/awd/views/teacher/TeacherAwdOverviewView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['teacher', 'admin'],
          title: 'AWD 教学总览',
      ...
      {
        path: 'academy/awd-reviews/:contestId/teams',
        name: 'TeacherAwdTeams',
        component: () => import('@/modules/awd/views/teacher/TeacherAwdTeamsView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['teacher', 'admin'],
          title: 'AWD 队伍复盘',
      ...
      {
        path: 'academy/awd-reviews/:contestId/services',
        name: 'TeacherAwdServices',
        component: () => import('@/modules/awd/views/teacher/TeacherAwdServicesView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['teacher', 'admin'],
          title: 'AWD Service 复盘',
          contentLayout: 'bleed',
        },
      },
      {
        path: 'academy/awd-reviews/:contestId/replay',
        name: 'TeacherAwdReplay',
        component: () => import('@/modules/awd/views/teacher/TeacherAwdReplayView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['teacher', 'admin'],
          title: 'AWD 轮次回放',
      ...
      {
        path: 'academy/awd-reviews/:contestId/export',
        name: 'TeacherAwdExport',
        component: () => import('@/modules/awd/views/teacher/TeacherAwdExportView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['teacher', 'admin'],
          title: 'AWD 报告导出',
      ...
      {
        path: 'platform/contests/:id/awd/overview',
        name: 'AdminAwdOverview',
        component: () => import('@/modules/awd/views/admin/AdminAwdOverviewView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 总览',
      ...
      {
        path: 'platform/contests/:id/awd/readiness',
        name: 'AdminAwdReadiness',
        component: () => import('@/modules/awd/views/admin/AdminAwdReadinessView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD Readiness',
      ...
      {
        path: 'platform/contests/:id/awd/rounds',
        name: 'AdminAwdRounds',
        component: () => import('@/modules/awd/views/admin/AdminAwdRoundsView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 轮次控制台',
      ...
      {
        path: 'platform/contests/:id/awd/services',
        name: 'AdminAwdServices',
        component: () => import('@/modules/awd/views/admin/AdminAwdServicesView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 服务矩阵',
      ...
      {
        path: 'platform/contests/:id/awd/attacks',
        name: 'AdminAwdAttacks',
        component: () => import('@/modules/awd/views/admin/AdminAwdAttacksView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 攻击日志',
      ...
      {
        path: 'platform/contests/:id/awd/traffic',
        name: 'AdminAwdTraffic',
        component: () => import('@/modules/awd/views/admin/AdminAwdTrafficView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 流量态势',
      ...
      {
        path: 'platform/contests/:id/awd/alerts',
        name: 'AdminAwdAlerts',
        component: () => import('@/modules/awd/views/admin/AdminAwdAlertsView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 告警中心',
      ...
      {
        path: 'platform/contests/:id/awd/instances',
        name: 'AdminAwdInstances',
        component: () => import('@/modules/awd/views/admin/AdminAwdInstancesView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 实例运维',
      ...
      {
        path: 'platform/contests/:id/awd/replay',
        name: 'AdminAwdReplay',
        component: () => import('@/modules/awd/views/admin/AdminAwdReplayView.vue'),
        meta: {
          requiresAuth: true,
          roles: ['admin'],
          title: 'AWD 赛后复盘与导出',
