  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '靶场管理', icon: 'Settings' },
      },
      {
        path: 'admin/challenges/:id',
        name: 'AdminChallengeDetail',
        component: () => import('@/views/admin/ChallengeDetail.vue'),
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '靶场详情' },
      },
      {
        ...
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '拓扑编排' },
      },
      {
        ...
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '环境模板', icon: 'Server' },
      },
      {
        path: 'admin/challenges/:id/writeup',
        name: 'AdminChallengeWriteup',
        component: () => import('@/views/admin/ChallengeWriteup.vue'),
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '题解管理' },
      },
      {
        path: 'admin/contests',
        name: 'ContestManage',
      ...
      },
      {
        ...
        meta: { requiresAuth: true, roles: ['teacher', 'admin'], title: '镜像管理', icon: 'Layers' },
      },
      {
        path: 'admin/cheat',
        name: 'CheatDetection',
