...
const shellPath = `${process.cwd()}/src/shared/ui/common/modal-templates/ModalTemplateShell.vue`
const overlayPortalPath = `${process.cwd()}/src/shared/ui/common/modal-templates/OverlayPortal.vue`
const overlayBehaviorPath = `${process.cwd()}/src/shared/lib/overlay/useOverlayBehavior.ts`
const classicPath = `${process.cwd()}/src/shared/ui/common/modal-templates/ClassicCenteredModal.vue`
const drawerPath = `${process.cwd()}/src/shared/ui/common/modal-templates/SlideOverDrawer.vue`
const minimalPath = `${process.cwd()}/src/shared/ui/common/modal-templates/MinimalFloatingModal.vue`
const cTooltipPath = `${process.cwd()}/src/shared/ui/common/modal-templates/CContextTooltip.vue`
const cPopoverPath = `${process.cwd()}/src/shared/ui/common/modal-templates/CLightActionPopover.vue`
const cConfirmPath = `${process.cwd()}/src/shared/ui/common/modal-templates/CImmersiveConfirmDialog.vue`
const cInputPath = `${process.cwd()}/src/shared/ui/common/modal-templates/CFocusedInputDialog.vue`
const adminModalPath = `${process.cwd()}/src/shared/ui/common/modal-templates/AdminSurfaceModal.vue`
const adminDrawerPath = `${process.cwd()}/src/shared/ui/common/modal-templates/AdminSurfaceDrawer.vue`
...
describe('modal templates', () => {
  ...
  it('业务代码新增弹窗不应直接继承 ModalTemplateShell 视觉包装', () => {
    ...
    const allowedDirectUsers = new Set([
      path.join(sourceRoot, 'shared/ui/common/DeleteConfirmModal.vue'),
      path.join(sourceRoot, 'shared/ui/common/modal-templates/ClassicCenteredModal.vue'),
      path.join(sourceRoot, 'shared/ui/common/modal-templates/CFocusedInputDialog.vue'),
      path.join(sourceRoot, 'shared/ui/common/modal-templates/CImmersiveConfirmDialog.vue'),
      path.join(sourceRoot, 'shared/ui/common/modal-templates/MinimalFloatingModal.vue'),
      path.join(sourceRoot, 'shared/ui/common/modal-templates/SlideOverDrawer.vue'),
    ])
