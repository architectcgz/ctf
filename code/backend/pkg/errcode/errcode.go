...
var (
	...
	ErrAccessTokenExpired    = New(11002, "会话已失效或不存在", http.StatusUnauthorized)
	ErrRefreshTokenExpired   = New(11003, "会话已过期", http.StatusUnauthorized)
	ErrTokenInvalid          = New(11004, "Session Cookie 格式无效", http.StatusUnauthorized)
	ErrTokenRevoked          = New(11005, "会话已被吊销", http.StatusUnauthorized)
