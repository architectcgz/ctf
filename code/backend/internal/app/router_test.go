...
func TestNewRouterRegistersStudentChallengeRoutes(t *testing.T) {
	...
	assertRouteHandlerContains(t, router, "PUT", "/api/v1/teacher/writeup-submissions/:id/review", "internal/module/challenge/api/http")
	...
	assertRouteHandlerContains(t, router, "POST", "/api/v1/admin/challenge-imports", "internal/module/challenge/api/http")
	assertRouteHandlerContains(t, router, "GET", "/api/v1/admin/challenge-imports/:id", "internal/module/challenge/api/http")
	assertRouteHandlerContains(t, router, "POST", "/api/v1/admin/challenge-imports/:id/commit", "internal/module/challenge/api/http")
	assertRouteHandlerContains(t, router, "POST", "/api/v1/admin/challenges/:id/self-check", "internal/module/challenge/api/http")
