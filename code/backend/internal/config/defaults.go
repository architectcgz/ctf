...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("auth.oauth.client_registration_enabled", true)
	v.SetDefault("auth.oauth.allowed_redirect_uri_prefixes", []string{})
	v.SetDefault("auth.oauth.redis_key_prefix", "ctf:auth:oauth")
	...
	v.SetDefault("rate_limit.mcp.enabled", true)
	v.SetDefault("rate_limit.mcp.limit", 120)
	v.SetDefault("rate_limit.mcp.window", time.Minute)
	...
	v.SetDefault("runtime_agent.node_name", "")
	v.SetDefault("runtime_agent.endpoint", "")
	v.SetDefault("runtime_agent.dial_timeout", 5*time.Second)
	v.SetDefault("runtime_agent.keepalive_time", 30*time.Second)
	v.SetDefault("runtime_agent.keepalive_timeout", 10*time.Second)
	...
	v.SetDefault("runtime_agent.server.node_name", "")
	...
	v.SetDefault("runtime_agent.server.keepalive_min_time", 30*time.Second)
