...
type AWDServiceTemplateStatus string

const (
	AWDServiceTemplateStatusDraft     AWDServiceTemplateStatus = "draft"
	AWDServiceTemplateStatusPublished AWDServiceTemplateStatus = "published"
	AWDServiceTemplateStatusArchived  AWDServiceTemplateStatus = "archived"
)
...
type AWDServiceTemplate struct {
	...
	Status           AWDServiceTemplateStatus `gorm:"column:status"`
...
func (AWDServiceTemplate) TableName() string {
	return "awd_service_templates"
}
