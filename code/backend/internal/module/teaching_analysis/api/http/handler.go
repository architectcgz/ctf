...
type Handler struct {
	service              teachinganalysisqueries.Service
	overviewService      teachinganalysisqueries.OverviewService
	classInsightService  teachinganalysisqueries.ClassInsightService
	studentReviewService teachinganalysisqueries.StudentReviewService
}
