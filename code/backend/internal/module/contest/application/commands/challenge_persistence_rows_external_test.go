...
type contestCommandChallengeRow struct {
...
func (contestCommandChallengeRow) TableName() string {
	return "challenges"
}

type contestCommandImageRow struct {
	ID          int64          `gorm:"column:id;primaryKey"`
...
func (contestCommandImageRow) TableName() string {
	return "images"
}
