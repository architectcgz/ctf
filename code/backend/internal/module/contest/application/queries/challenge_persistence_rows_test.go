...
type contestQueryChallengeRow struct {
...
func (contestQueryChallengeRow) TableName() string {
	return "challenges"
}

type contestQueryImageRow struct {
	ID          int64          `gorm:"column:id;primaryKey"`
...
func (contestQueryImageRow) TableName() string {
	return "images"
}
