...
type stubContestService struct {
	createContestFunc func(ctx context.Context, req contestcmd.CreateContestInput) (*contestcmd.ContestResp, error)
	updateContestFunc func(ctx context.Context, id int64, req contestcmd.UpdateContestInput) (*contestcmd.ContestResp, error)
}

func (s stubContestService) CreateContest(ctx context.Context, req contestcmd.CreateContestInput) (*contestcmd.ContestResp, error) {
...
func (s stubContestService) UpdateContest(ctx context.Context, id int64, req contestcmd.UpdateContestInput) (*contestcmd.ContestResp, error) {
...
func (stubAWDCommandService) UpsertServiceCheck(ctx context.Context, contestID, roundID int64, req contestcmd.UpsertServiceCheckInput) (*contestcmd.AWDTeamServiceResp, error) {
	return nil, nil
}
...
func (stubAWDServiceCommandService) CreateContestAWDService(ctx context.Context, contestID int64, req contestcmd.CreateContestAWDServiceInput) (*contestcmd.ContestAWDServiceResp, error) {
	return nil, nil
}
