...
type teamCommandService interface {
	CreateTeam(ctx context.Context, contestID, captainID int64, req contestcmd.CreateTeamInput) (*contestcmd.TeamResp, error)
	JoinTeam(ctx context.Context, contestID, userID, teamID int64) (*contestcmd.TeamResp, error)
