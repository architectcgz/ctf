...
func (s teamCommandAdapterSourceStub) FindByID(ctx context.Context, id int64) (*contestentity.Team, error) {
	if s.findByIDFn != nil {
...
func (s teamCommandAdapterSourceStub) FindContestRegistration(ctx context.Context, contestID, userID int64) (*contestentity.ContestRegistration, error) {
...
func (s teamCommandAdapterSourceStub) FindUserTeamInContest(ctx context.Context, userID, contestID int64) (*contestentity.Team, error) {
...
func (s teamCommandAdapterSourceStub) CreateWithMember(ctx context.Context, team *contestentity.Team, captainID int64) error {
...
func (s teamCommandAdapterSourceStub) GetMembers(context.Context, int64) ([]*contestentity.TeamMember, error) {
	return nil, nil
}
...
func TestTeamCommandAdapterMapsCreateWithMemberRegistrationBindingNotFoundErrors(t *testing.T) {
	...
	err := repo.CreateWithMember(context.Background(), &contestentity.Team{}, 1)
