...
type teachingQueryChallengeRepoRow struct {
...
func (teachingQueryChallengeRepoRow) TableName() string {
	return "challenges"
}
...
func TestRepositoryListClassTeachingFactSnapshotsUsesUnifiedContestAndAWDSubmissionSemantics(t *testing.T) {
	...
	challenges := []teachingQueryChallengeRepoRow{
	...
	logs := []contestcontracts.AWDAttackLog{
		{ID: 11, RoundID: 81, AttackerTeamID: 91, VictimTeamID: 101, ServiceID: 111, AWDChallengeID: 901, AttackType: contestcontracts.AWDAttackTypeFlagCapture, Source: contestcontracts.AWDAttackSourceSubmission, IsSuccess: false, ScoreGained: 0, SubmittedByUserID: ptrTeachingQueryInt64(11), CreatedAt: now.Add(3 * time.Minute)},
		{ID: 12, RoundID: 81, AttackerTeamID: 91, VictimTeamID: 102, ServiceID: 112, AWDChallengeID: 901, AttackType: contestcontracts.AWDAttackTypeFlagCapture, Source: contestcontracts.AWDAttackSourceSubmission, IsSuccess: true, ScoreGained: 80, SubmittedByUserID: ptrTeachingQueryInt64(11), CreatedAt: now.Add(4 * time.Minute)},
		{ID: 13, RoundID: 82, AttackerTeamID: 91, VictimTeamID: 103, ServiceID: 113, AWDChallengeID: 902, AttackType: contestcontracts.AWDAttackTypeFlagCapture, Source: contestcontracts.AWDAttackSourceSubmission, IsSuccess: true, ScoreGained: 90, SubmittedByUserID: ptrTeachingQueryInt64(11), CreatedAt: now.Add(5 * time.Minute)},
		{ID: 14, RoundID: 82, AttackerTeamID: 91, VictimTeamID: 104, ServiceID: 114, AWDChallengeID: 902, AttackType: contestcontracts.AWDAttackTypeFlagCapture, Source: contestcontracts.AWDAttackSourceManual, IsSuccess: true, ScoreGained: 100, SubmittedByUserID: ptrTeachingQueryInt64(11), CreatedAt: now.Add(6 * time.Minute)},
	}
	for _, log := range logs {
		if err := db.Create(&log).Error; err != nil {
			t.Fatalf("seed awd attack log %d: %v", log.ID, err)
