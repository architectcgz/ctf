...
type Instance struct {
	...
	ProvisioningStage     string     `gorm:"column:provisioning_stage;size:64;not null;default:''"`
	ProvisioningAttempt   int        `gorm:"column:provisioning_attempt;not null;default:0"`
	LastProvisioningError string     `gorm:"column:last_provisioning_error;type:text;not null;default:''"`
