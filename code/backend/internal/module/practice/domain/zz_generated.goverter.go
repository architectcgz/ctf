...
func (c *PracticeResponseMapperImpl) ToInstanceResp(source *model.Instance) *dto.InstanceResp {
...
func (c *PracticeResponseMapperImpl) timeTimeToTimeTime(source time.Time) time.Time {
	return source
}
