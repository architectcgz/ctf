...
type stubPracticeRepository struct {
	withinTransactionFn                  func(ctx context.Context, fn func(txRepo PracticeRepository) error) error
	...
	lockInstanceScopeFn                  func(userID int64, scope InstanceScope) error
	findScopedExistingInstanceFn         func(userID, challengeID int64, scope InstanceScope) (*model.Instance, error)
	countScopedRunningInstancesFn        func(userID int64, scope InstanceScope) (int, error)
...
func (s *stubPracticeRepository) WithinTransaction(ctx context.Context, fn func(txRepo PracticeRepository) error) error {
...
func (s *stubPracticeRepository) LockInstanceScope(userID int64, scope InstanceScope) error {
...
func (s *stubPracticeRepository) FindScopedExistingInstance(userID, challengeID int64, scope InstanceScope) (*model.Instance, error) {
...
func (s *stubPracticeRepository) CountScopedRunningInstances(userID int64, scope InstanceScope) (int, error) {
