...
- 完成 `contest-team-command-handler-split-phase3`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-scoreboard-handler-split-phase3`：
...
- 完成 `contest-handler-split-phase3`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-participation-command-handler-split-phase3`：
...
- 完成 `contest-submission-scoring-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-awd-service-check-result-split-phase4`：
...
- 完成 `contest-awd-service-run-command-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-awd-validation-support-split-phase4`：
...
- 完成 `contest-team-membership-lifecycle-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-awd-service-upsert-command-split-phase4`：
...
- 完成 `contest-status-repository-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-update-command-split-phase4`：
...
- 完成 `contest-awd-round-runtime-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-team-create-command-split-phase4`：
...
- 完成 `contest-awd-domain-check-support-split-phase4`：
  ...
  - `contest/...` 与相关 `internal/app` 定向测试覆盖本轮无行为变化拆分
- 完成 `contest-awd-score-sync-support-split-phase4`：
