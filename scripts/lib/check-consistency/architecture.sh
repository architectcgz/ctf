run_architecture_checks() {
  ...
  check_contains "scripts/check-commit-message.sh" 'check_commit_message\.py' "commit message wrapper delegates to shared checker"
  check_contains "scripts/check-commit-message.sh" 'harness/policies/commit-message\.json' "commit message wrapper reads project policy"
