run_architecture_checks() {
  ...
  check_contains "harness/checks/check_local_harness_setup.sh" 'scripts/install-agent-symlinks\.sh' "doctor local harness setup checks installer entry"
  check_contains "harness/checks/check_local_harness_setup.sh" 'scripts/uninstall-agent-symlinks\.sh' "doctor local harness setup checks uninstaller entry"
