run_architecture_checks() {
  ...
  check_file "scripts/ensure-frontend-tooling.sh"
  ...
  check_file "harness/checks/check_review_governance_core.sh"
  ...
  check_file "harness/bridges/check-commit-message.sh"
  check_file "harness/bridges/check-skill-sync-reminder.sh"
  ...
  check_dir "harness/workflow-plugins/code-workflow/review-governance.d"
  ...
  check_contains "scripts/check-workflow-complete.sh" 'scripts/run-workflow-stage\.sh review-governance' "workflow complete runs review governance stage"
  ...
  check_contains "scripts/check-frontend-architecture.sh" 'ensure-frontend-tooling\.sh' "frontend architecture checks ensure shared tooling"
  ...
  check_contains "scripts/check-review-governance-core.sh" 'harness/checks/check_review_governance_core\.sh' "review governance core wrapper delegates to harness checks"
  ...
  check_contains "scripts/check-commit-message.sh" 'harness/bridges/check-commit-message\.sh' "commit message wrapper delegates to project bridge"
  check_contains "harness/bridges/check-commit-message.sh" 'check_commit_message\.py' "commit message bridge delegates to shared checker"
  check_contains "harness/bridges/check-commit-message.sh" 'harness/policies/commit-message\.json' "commit message bridge reads project policy"
  check_contains "scripts/check-skill-sync-reminder.sh" 'harness/bridges/check-skill-sync-reminder\.sh' "skill sync wrapper delegates to project bridge"
  check_contains "harness/bridges/check-skill-sync-reminder.sh" 'remind_skill_sync\.py' "skill sync bridge delegates to shared reminder"
  ...
  check_contains ".githooks/README.md" 'review-governance' "hook docs mention review stage"
  ...
  check_contains ".githooks/README.md" 'harness/bridges/' "hook docs mention harness bridges"
