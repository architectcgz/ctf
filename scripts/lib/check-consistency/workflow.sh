run_workflow_checks() {
  ...
  check_file "harness/workflow-plugins/code-workflow/cleanup_task_worktree.sh"
  ...
  check_contains "AGENTS.md" 'harness/workflow-plugins/code-workflow/cleanup_task_worktree\.sh' "AGENTS references workflow cleanup entry"
