...
18. If a local entrypoint guard exists, require the initialization workflow to run it after creating the root files, for example `bash <project-root>/scripts/check-agent-entrypoints.sh`.
